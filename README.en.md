...
- [One-page overview (PDF)](docs/kopilotti-sales-customer-investor-summary.pdf)
- [Investor & partner brief (PDF, 2 pages)](docs/kopilotti-sales-investor-partner-brief-en.pdf)
...
This is the English overview. The Finnish README, [README.md](README.md), is this repository's default on GitHub and is the detailed original product description, including the full production-status breakdown, architecture notes and roadmap.
